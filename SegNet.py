...
class SegNet(nn.Module):
    ...
    def init_weights(self):
        ...
        self.EnConvS1_2.weight.data.copy_(vgg.features[1].weight.data)
        self.EnConvS1_2.bias.data.copy_(vgg.features[1].bias.data)

        self.EnConvS2_1.weight.data.copy_(vgg.features[3].weight.data)
        self.EnConvS2_1.bias.data.copy_(vgg.features[3].bias.data)
        self.EnConvS2_2.weight.data.copy_(vgg.features[4].weight.data)
        self.EnConvS2_2.bias.data.copy_(vgg.features[4].bias.data)

        self.EnConvS3_1.weight.data.copy_(vgg.features[6].weight.data)
        self.EnConvS3_1.bias.data.copy_(vgg.features[6].bias.data)
        self.EnConvS3_2.weight.data.copy_(vgg.features[7].weight.data)
        self.EnConvS3_2.bias.data.copy_(vgg.features[7].bias.data)
        self.EnConvS3_3.weight.data.copy_(vgg.features[8].weight.data)
        self.EnConvS3_3.bias.data.copy_(vgg.features[8].bias.data)

        self.EnConvS4_1.weight.data.copy_(vgg.features[10].weight.data)
        self.EnConvS4_1.bias.data.copy_(vgg.features[10].bias.data)
        self.EnConvS4_2.weight.data.copy_(vgg.features[11].weight.data)
        self.EnConvS4_2.bias.data.copy_(vgg.features[11].bias.data)
        self.EnConvS4_3.weight.data.copy_(vgg.features[12].weight.data)
        self.EnConvS4_3.bias.data.copy_(vgg.features[12].bias.data)

        self.EnConvS5_1.weight.data.copy_(vgg.features[14].weight.data)
        self.EnConvS5_1.bias.data.copy_(vgg.features[14].bias.data)
        self.EnConvS5_2.weight.data.copy_(vgg.features[15].weight.data)
        self.EnConvS5_2.bias.data.copy_(vgg.features[15].bias.data)
        self.EnConvS5_3.weight.data.copy_(vgg.features[16].weight.data)
        self.EnConvS5_3.bias.data.copy_(vgg.features[16].bias.data)
